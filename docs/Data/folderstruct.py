...
def create_folders(data, parent_path):
    for key, value in data.items():
        ...
        with open(os.path.join(current_path, "About.md"), "w") as about_file:
            about_file.write(f"# {key}\n\nThis is a brief description of {key}.\n")
        
        if isinstance(value, dict):
            create_folders(value, current_path)

with open("/Users/hiren/Documents/pravritti/shabdakosh/Data/branches_of_education.json", "r") as file:
